#!/usr/bin/env node
 ...
 function printSimpleMenu() {
     console.log("======================================================");
     console.log('===========  If you want to return main menu press (Shift+q) ===========');
     console.log('===========  If you want to exit press (Ctrl+C)              ===========');
     console.log("======================================================\n");
 }
 
 /**
  *This method creates console interface to read line
  * @returns {*}
  */
 ...
 /**
  * This will Kill the process and exit.
  */
 function exit() {
 ...
 /**
  * This will Resolve the game strategy according to the users given input
  */
 ...
 /**
  * This is used to Print game results
  * @param results
  */
